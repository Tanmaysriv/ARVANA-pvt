    ...
    <section className="py-20 bg-primary-100">
      <div className="container mx-auto px-6">
        ...
        <div className="relative">
          {/* Connection Line */}
          <div className="hidden md:block absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-sky-200 via-purple-200 to-emerald-200 transform -translate-y-1/2 z-0"></div>
          ...
          <div className="grid md:grid-cols-4 gap-8 relative z-10">
            {steps.map((step, index) => {
              ...
              return (
                ...
                >
                  {/* Step Card */}
                  <div className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 p-6 border-2 border-slate-100 hover:border-sky-300 group">
                    {/* Number Badge */}
                    ...
                    <div className="mt-8 mb-4 flex justify-center">
                      <div className="w-16 h-16 bg-slate-100 rounded-xl flex items-center justify-center group-hover:bg-sky-100 transition-colors">
                        <Icon className="w-8 h-8 text-slate-600 group-hover:text-sky-600 transition-colors" />
                      </div>
                    </div>

                    {/* Title */}
                    <h3 className="text-xl font-bold text-slate-900 mb-3 text-center min-h-[3.5rem]">
                      {step.title}
                    </h3>
                    ...
                    {/* Description */}
                    <p className="text-slate-600 text-center mb-4 min-h-[4.5rem]">
                      {step.description}
                    </p>

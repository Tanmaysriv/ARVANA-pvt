  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-secondary': 'linear-gradient(135deg, #171717 0%, #000000 100%)',
        'gradient-accent': 'linear-gradient(135deg, #fbbf24 0%, #f59e0b 100%)',
        'gradient-dark': 'linear-gradient(135deg, #000000 0%, #171717 100%)',
        'gradient-hero': 'linear-gradient(135deg, #000000 0%, #171717 50%, #f59e0b 100%)',
      ...
      boxShadow: {
        ...
        'glow-black': '0 0 20px rgba(0, 0, 0, 0.5)',
